...
router.post('/upload-profile-pic', upload.single('profile_pic'), homecontroller.profile)
router.post('/upload-multiple-images',upload.array('multiple_images',3),homecontroller.uploadmultiple)
